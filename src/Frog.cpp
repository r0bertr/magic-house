...
MyFrog::MyFrog(const char *texturePath_, glm::vec3 tempPos, glm::vec3 tempScale, glm::vec3 tempRotAxis, GLfloat tempRotate) {
	...
	// Initialize Shader
	Shader *shader = ResourceManager::GetInstance()->loadShader( "res/shaders/TextVertexShader.vs", "res/shaders/TextVertexShader.fs", NULL, "text");
...
void MyFrog::printText2D(const char *text, int x, int y, int size) {

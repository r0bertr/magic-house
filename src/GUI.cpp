...
void GUI::renderParticleConsole(ParticleAttributes *parAttrs) {
    ...
    ImGui::SliderFloat3("init_position_mean",
        glm::value_ptr(parAttrs->initPosition.mean), -5.f, 5.f);
    ImGui::SliderFloat3("init_position_variance",
        glm::value_ptr(parAttrs->initPosition.variance), -5.f, 5.f);
    ImGui::SliderFloat3("init_direction_mean",
        glm::value_ptr(parAttrs->initDirection.mean), -5.f, 5.f);
    ImGui::SliderFloat3("init_direction_variance",
        glm::value_ptr(parAttrs->initDirection.variance), -5.f, 5.f);
    ...
    ImGui::SliderFloat3("init_size_mean",
        glm::value_ptr(parAttrs->initSize.mean), -5.f, 5.f);
    ImGui::SliderFloat3("init_size_variance",
        glm::value_ptr(parAttrs->initSize.variance), -5.f, 5.f);
    ...
    ImGui::SliderFloat3("gravity_dir",
        glm::value_ptr(parAttrs->gravityDir), -5.f, 5.f);
